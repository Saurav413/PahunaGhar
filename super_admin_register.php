            ...
            if ($stmt->fetch()) {
                ...
                if ($stmt->fetch()) {
                    ...
                    if ($stmt->execute([$name, $email, $hashed_password, $admin_role])) {
                        $success = ucfirst($admin_role) . ' account created successfully!';
                    } else {
...
<head>
    ...
    <title>Super Admin - Create Admin Account - PahunaGhar</title>
...
<body>
    <nav class="navbar">
        <div class="navbar-left">
            <a href="super_admin_dashboard.php" class="logo logo-blue">Pahuna<span class="logo-highlight">Ghar</span> <span class="super-admin-badge">Super Admin</span></a>
        </div>
    ...
    <div class="container register-container">
        ...
        <form class="register-form register-form-styled" method="post" action="">
            ...
            <select id="admin_role" name="admin_role" required>
                <option value="admin" <?php echo ($_POST['admin_role'] ?? 'admin') === 'admin' ? 'selected' : ''; ?>>Admin</option>
        ...
        <p class="register-login">Back to <a href="super_admin_dashboard.php" class="login-link">Dashboard</a></p>
    </div>
